...
import com.sunnychung.lib.multiplatform.bigtext.extension.addToThisAscendingListWithoutDuplicate
...
//        }
        ...
        log.v { "deleteUnchecked -- before layout" }
        ...
        log.v { "deleteUnchecked -- after inner layout 1" }

        if (!isSkipLayout) {
            layout(maxOf(0, start - 1), minOf(length, start + 1))
        }

        log.v { "deleteUnchecked -- after inner layout 2" }
